...
SOURCES=("$ROOT/src/compute/vector/vector_core/vector_alu.sv" "$ROOT/src/compute/vector/vector_core/vector_exp.sv" "$ROOT/src/compute/vector/vector_core/vector_sqrt.sv")
verilator --lint-only --top-module vector_alu "${SOURCES[@]}"

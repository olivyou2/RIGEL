module dma_addr_src_tb ();
    ...
    assign addr_out = dma_addr_read_req.addr;
    assign addr_out_valid = dma_addr_read_req.valid;
    assign dma_addr_read_req.ready = addr_out_ready;
    dma_src_addr #(
        ...
        .read_req(dma_addr_read_req)
    );

    task automatic set_src_addr(input logic [ADDR_WIDTH-1:0] addr_src,
